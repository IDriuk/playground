...
- [Storybook guide](https://storybook.js.org/tutorials/intro-to-storybook/react/en/get-started/)
- [Tailwind installation](https://tailwindcss.com/docs/installation/using-vite)
- [Storybook with tailwind example repo](https://github.com/audunru/tailwind-storybook/tree/main) 
